...
<section class="error-area-1 position-relative">
    <div class="container">
        <div class="error-img">
            <img class="w-100 h-120 img-fluid" src="{{asset("assets/img/normal/error_1_1.png")}}" alt="404 image">
        </div>
        <div class="row">
            <div class="col-lg-6">
                <div class="error-content">
                    <h2 class="error-title">Thank You</h2>
                    <h3 class="error-subtitle">Our Team will contact you further</h3>
            ...
            <div class="container">
                ...
                <div class="page-single bg-title-dark">
                    <div class="page-img mb-30">
                        <img class="w-100 rounded-20" src="{{asset("assets/img/thank_you.jpg")}}" alt="portfolio Image">
                    </div>
